...
class UportDIDResolverTest {
    ...
    fun `calls registry with correct payload`() = runBlocking {
        ...
        assertThat(encodedCallSlot.captured).isEqualTo("0x447885f075506f727450726f66696c654950465331323230000000000000000000000000000000000000000000000000f12c30cd32b4a027710c150ae742f50db0749213000000000000000000000000f12c30cd32b4a027710c150ae742f50db0749213")
    ...
    fun `can convert legacy UportIdentityDocument to DIDDocument`() {
        ...
        assertThat(verificationPkMatch).isNotNull()
        ...
        assertThat(encPkMatch).isNotNull()
    }
